-- Add a terminal failed status to the engine task workflow.
...
SELECT id, project_id, parent_id, external_key, title, description, task_type, status, priority, approval_status, assigned_agent, created_at, updated_at, started_at, completed_at
FROM tasks_legacy;
