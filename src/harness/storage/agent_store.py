...
class AgentStore:
    ...
    def create(self, name: str, *, description: str = "", capabilities: str = "[]") -> int:
    ...
    def get(self, agent_id: int) -> Row | None:
        return self.connection.execute("SELECT * FROM agents WHERE id = ?", (agent_id,)).fetchone()

    def assign(self, task_id: int, agent_id: int, assignment_type: str = "execution") -> int:
        return self.connection.execute(
